...
io.on("connection", (socket) => {
  ...
  socket.on('bet', async (data) => {
    ...
    // await User.findByIdAndUpdate(req.user.id, { bet_amount: bet_amount, payout_multiplier: payout_multiplier })
    // await User.findByIdAndUpdate(req.user.id, { balance: thisUser.balance - bet_amount })
